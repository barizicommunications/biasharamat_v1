            ...
            <div class="flex flex-wrap md:flex-nowrap space-x-20">
                <div class="w-3/4">
                    <div class="bg-white p-8 mb-8">
                        ...
                        <p class="text-[#9D9D9D]">Thank you for submitting your business details.</p>
                        ...
                        <p class="text-[#f08181]">{{ session('success') ? 'Approved' : 'Pending' }}</p>
                    </div>
                </div>
                    ...
                    <ol class="text-gray-500 border-l border-[#c4c4c4] sticky top-10">
                        <li class="mb-10 ml-6">
                            <span class="absolute flex items-center justify-center w-10 h-10 bg-green-200 rounded-full -left-5">
                                <svg class="w-3.5 h-3.5 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5"/>
                                </svg>
                            </span>
                            <div class="ml-3 text-green-500">
                                <h3 class="font-medium leading-tight">Provide details</h3>
